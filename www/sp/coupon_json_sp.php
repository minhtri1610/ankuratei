...
function getCoupons($conn){
	...
	$sql=<<<END
select name as cpnname,coalesce(normal_price,0) as genka ,coupon_price as tokka,pictname_sp as imgname,case when nazopon_flg = 1 then 0 else c_sortkey end as sortkey  from m_coupon
 where
