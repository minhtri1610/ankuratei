...
<img src='<?= $imgdir ?>/<?= $coupon['pictname_sp'] ?>' width='20%' align=left><?= $coupon['name'] ?></a></li>
<?php
...
function jumpList(){
	location.href="couponlist_honpo.php";
}
//-->
</script>
<style>
...
<h1><a href="index.html"><img src="images/honpologo_coupon.jpg" width="60" height="44"></a> お得なクーポン</h1>
