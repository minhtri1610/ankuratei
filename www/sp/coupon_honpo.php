...
ご注文の際にこちらの画面を店員に提示してください。クーポンのご利用注文点数の上限は、ご来店人数×２点迄となります。但し、アルコールクーポンについてはご利用注文点数の上限内で、成人のお客様人数×２点を上限とさせていただきます。その他の割引サービスとは併用できません。また、浦和大谷口店ではご利用になれませんのでご了承ください。 
 <br> 
<br>
<div align=center>	<ul>	
